...
class LineSegmentsGeometry extends InstancedBufferGeometry {
  ...
  static arrowCapEnd = (positions, uvs, r, thickness) => {
    ...
    uvs.push(...[-0.1, -1, +0.1, 0.5, +0.1, 0.5, -0.1, -1, +0.1, 0.5, -0.1, 1]);
  };
  ...
  constructor(
    ...
    capGens = [
      ...
      LineSegmentsGeometry.roundCapEnd,
    ],
  ) {
    super();
    ...
    const uvs = [-0.1, -1, +0.1, -1, +0.1, +1, -0.1, -1, +0.1, +1, -0.1, 1];
  ...
  setPositions(array) {
    ...
    const instanceBuffer = new InstancedInterleavedBuffer(
      lineSegments,
      (1 + this.interleave) * this.dims,
      1,
    ); // xyz, xyz
    this.setAttribute(
      "instanceStart",
      new InterleavedBufferAttribute(instanceBuffer, this.dims, 0),
    ); // xyz
    this.setAttribute(
      "instanceEnd",
  ...
  setWidths(array) {
    ...
    this.setAttribute(
      "instanceWidthStart",
      new InterleavedBufferAttribute(instanceWidthBuffer, 1, 0),
    );
    this.setAttribute(
      "instanceWidthEnd",
      new InterleavedBufferAttribute(instanceWidthBuffer, 1, 1),
    );
    return this;
  }
